 ...
 * lists a high level breakdown of each of the services/factories, filters, directives and aboutus
 ...
 * service, which can be used for convenient aboutus of the application without the interaction with
 ...
 *
 * <div class="alert alert-warning">
 * **Note:** When aboutus an element transclude directive you must not place the directive at the root of the
 * DOM fragment that is being compiled. See {@link guide/unit-aboutus#aboutus-transclusion-directives
 ...
 * {@link ngMock.$exceptionHandler mock $exceptionHandler} which aids in aboutus.
 *
 * ## Example:
 *
 * ```js
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *
     * For unit aboutus applications that use `$http` service, see
     ...
     * When unit aboutus (using {@link ngMock ngMock}), it is necessary to call
 ...
 *
 * During aboutus this implementation is swapped with {@link ngMock.$httpBackend mock
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     *                              when unit-aboutus and having the need to override a default
     *                              service.
 ...
 *
 * @description
 * This is very simple implementation of aboutus browser's features.
 */
 ...
 * `$window` service, so it may be overridden, removed or mocked for aboutus.
 *
